...
; GIO locates this beside libgio first and uses it for the private Win32
; session-bus autolaunch that backs unique GApplication instances.
Source: "@MINGW_DIR@\bin\gdbus.exe"; DestDir: "{app}\bin"; Components: main
...
begin
  ...
  for iLineCounter := 0 to iSize-1 do
    begin
      ...
      begin
        StringChangeEx(EnvStrList[iLineCounter], '{GUILE_LOAD_PATH}', '{GNC_HOME}/share/guile/@GUILE_VERSION@;{GUILE_LOAD_PATH}', True);
